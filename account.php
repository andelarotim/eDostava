...
<html class="no-js" lang="en">
  <head>
    ...
    <title>eDostava | Moj račun</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">eDostava - Moj račun</a></h1>
        </li>
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        <p><?php echo '<h3>Pozdrav, ' .$_SESSION['fname'] .'!</h3>'; ?></p>

        <p><h4>Detalji računa</h4></p>

        <p>Ispod se nalaze detalji vašeg računa. Ukoliko želite promijeniti Vaše podatke, unesite promjene u željena polja i stisnite 'Spremi'.</p>
      </div>
    </div>
        ...
        <div class="small-12">
            ...
            <div class="small-8 columns end">
              <?php
                ...
                if($result) {
                  ...
                  echo '<label for="right-label" class="right inline">Prezime</label>';
                  echo '</div>';
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">Adresa</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">Grad</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">Poštanski broj</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
              ...
              echo '<div class="row">';
              echo '<div class="small-3 columns">';
              echo '<label for="right-label" class="right inline">Lozinka</label>';
              echo '</div>';
              echo '<div class="small-8 columns end">';
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" value="Spremi" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
