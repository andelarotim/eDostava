...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">eDostava - Kontakt</a></h1>
        </li>
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        ...
        <p>Želite nas izravno kontaktirati? Javite nam se na <a href="mailto:support@edostava.com">support@edostava.com</a></p>
