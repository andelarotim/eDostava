...
<html class="no-js" lang="en">
  <head>
    ...
    <title>eDostava | Prijavi se</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">eDostava - Prijavi se</a></h1>
        </li>
      ...
      <!-- Right Nav Section -->
        ...
        <li><a href="about.php">O nama</a></li>
          ...
          if(isset($_SESSION['username'])){
            ...
            echo '<li class="active"><a href="login.php">Prijavi se</a></li>';
        ...
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="Vaš email" name="username">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" value="Prijavi se" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
