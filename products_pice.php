...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">eDostava - Pića</a></h1>
        </li>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        <h3 style="text-align:center;">Naša pića</h3>
        <br>
        <?php
          $i=0;
          $product_id = array();
          ...
          $result = $mysqli->query("SELECT * FROM products WHERE product_type='pice'");
          if($result === FALSE){
            die(mysql_error());
          }
