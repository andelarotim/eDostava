...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">eDostava - Pizze</a></h1>
        </li>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        <h3 style="text-align:center;">Naše pizze</h3>
        <br>
        <?php
          $i=0;
          $product_id = array();
          ...
          $result = $mysqli->query("SELECT * FROM products WHERE product_type='pizza'");
          if($result === FALSE){
            die(mysql_error());
          }
