...
<html class="no-js" lang="en">
  <head>
    ...
    <title>eDostava | Narudžba uspješna!</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">eDostava - Narudžba uspješna!</a></h1>
        </li>
    ...
    <div class="row" style="margin-top:10px;">
      <div style="background-color:#aaff80; border-radius: 10px; padding:5px;"class="small-12">
        <p>Uspjeh! Vaša narudžba je uspješno primljena. Molimo strpite se i dobar tek! :)</p>
        <p>Vaš račun je dostavljen na vašu email adresu. Hvala na povjerenju.</p>
